        ...
        <>
            <div className="container my-5">
                <div className="tools-heading">
                    ...
                    <p className='text-center'>Analyse, optimise and manage your trades with tools tailored to your needs.</p>
                    <div className="button text-center">
                        <button className="btn btn-sm btn-outline-primary" onClick={handleNavigateClick}>Discover our platforms</button>
                    </div>
                </div>
