              ...
              <div className="footer-container-main">
                ...
                <div className="footer-container-main-info my-5">
                  ...
                  <address>
                    ...
                    <p>Financial Park Complex Labuan Jalan Merdeka 87000 Labuan F.T, Malaysia.</p>
                    <p>TRUE TRADE PRO LTD. (LL18002) Lic: MB/22/0103 . </p>
                  </address>
                  <p>Labuan phone number: +60196508002</p>
                  <p>Authorized and Regulated by the Money Broking License from Labuan Financial Services Authority (LFSA).</p>
                </div>
